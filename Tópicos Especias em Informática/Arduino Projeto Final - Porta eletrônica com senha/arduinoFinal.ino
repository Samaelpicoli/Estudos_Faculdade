...
#include <Ethernet.h> //BIBLIOTECA PARA O FUNCIONAMENTO DA ETHERNET

int cont = 0;
Servo servo_Motor; //OBJETO DO TIPO SERVO
char password[5] = "2115"; //DEFINE SENHA DO USUARIO
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == 'n' && currentLineIsBlank) {
          ...
          // VERIFICA SE PORTA ESTA ABERTA OU TRANCADA
          ...
          //CONTA QUANTAS VEZES A PORTA FOI ABERTA
