...
create table tipo (
    codigo int NOT NULL AUTO_INCREMENT,
    codigo_moveis int NOT NULL,
    descricao varchar(50) NOT NULL,
    preco float NOT NULL,
    PRIMARY KEY (codigo),
    constraint fk_moveis foreign key (codigo_moveis) references moveis (codigo)
);
...
create table pedidos (
    ...
    PRIMARY KEY (codigo),
    constraint fk_codmoveis foreign key (codigo_produto) references tipo (codigo),
...
create table estoque (
    ...
    constraint fk_moveisfk foreign key (codigo_produto) references tipo (codigo)
);
